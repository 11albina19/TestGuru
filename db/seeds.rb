...
answers_data = [
  { body: 'Небольшой боковой отросток, побег дерева, кустарника или травянистого растения', correct: false, question: questions[3] },
  { body: 'Отдельная линия в системе дорог, отклоняющаяся в сторону от основного пути.', correct: false, question: questions[3] },
  ...
  { body: 'Миграции -  это способ упростить большие контроллеры или модели для лучшего понимания и управления.', correct: false, question: questions[4] },
